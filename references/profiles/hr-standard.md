# hr-standard profile (summary)

**Language:** `croatian` · **Overlay id:** `hr-standard`

Full rules: [languages/croatian/overlays/hr-standard.md](../languages/croatian/overlays/hr-standard.md).

Croatian overlay — load when `regional_voice: hr-standard` or user names this region/variety.

**When to load:** `language: croatian` + `regional_voice: hr-standard`.
...
**Locale techniques:** [locales/croatian.md](../techniques/locales/croatian.md) when use case matches.
