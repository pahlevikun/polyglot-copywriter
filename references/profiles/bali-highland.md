# bali-highland profile (summary)

**Language:** `bali` · **Overlay id:** `bali-highland`

Full rules: [languages/bali/overlays/bali-highland.md](../languages/bali/overlays/bali-highland.md).

Balinese overlay — load when `regional_voice: bali-highland` or user names this region/variety.

**When to load:** `language: bali` + `regional_voice: bali-highland`.
