# es-bo profile (summary)

**Language:** `spanish` · **Overlay id:** `es-bo`

Full rules: [languages/spanish/overlays/es-bo.md](../languages/spanish/overlays/es-bo.md).

Spanish overlay — load when `regional_voice: es-bo` or user names this region/variety.

**When to load:** `language: spanish` + `regional_voice: es-bo`.
