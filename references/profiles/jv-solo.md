# jv-solo profile (summary)

**Language:** `jawa` · **Overlay id:** `jv-solo`

Full rules: [languages/jawa/overlays/jv-solo.md](../languages/jawa/overlays/jv-solo.md).

Jawa overlay — load when `regional_voice: jv-solo` or user names this region/variety.

**When to load:** `language: jawa` + `regional_voice: jv-solo`.
