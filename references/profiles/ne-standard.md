# ne-standard profile (summary)

**Language:** `nepali` · **Overlay id:** `ne-standard`

Full rules: [languages/nepali/overlays/ne-standard.md](../languages/nepali/overlays/ne-standard.md).

Nepali overlay — load when `regional_voice: ne-standard` or user names this region/variety.

**When to load:** `language: nepali` + `regional_voice: ne-standard`.
...
**Locale techniques:** [locales/nepali.md](../techniques/locales/nepali.md) when use case matches.
