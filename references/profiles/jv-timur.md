# jv-timur profile (summary)

**Language:** `jawa` · **Overlay id:** `jv-timur`

Full rules: [languages/jawa/overlays/jv-timur.md](../languages/jawa/overlays/jv-timur.md).

Jawa overlay — load when `regional_voice: jv-timur` or user names this region/variety.

**When to load:** `language: jawa` + `regional_voice: jv-timur`.
...
**Locale techniques:** [locales/jawa.md](../techniques/locales/jawa.md) when use case matches.
