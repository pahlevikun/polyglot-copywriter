# ru-standard profile (summary)

**Language:** `russian` · **Overlay id:** `ru-standard`

Full rules: [languages/russian/overlays/ru-standard.md](../languages/russian/overlays/ru-standard.md).

Russian overlay — load when `regional_voice: ru-standard` or user names this region/variety.

**When to load:** `language: russian` + `regional_voice: ru-standard`.
...
**Locale techniques:** [locales/russian.md](../techniques/locales/russian.md) when use case matches.
