# lt-standard profile (summary)

**Language:** `lithuanian` · **Overlay id:** `lt-standard`

Full rules: [languages/lithuanian/overlays/lt-standard.md](../languages/lithuanian/overlays/lt-standard.md).

Lithuanian overlay — load when `regional_voice: lt-standard` or user names this region/variety.

**When to load:** `language: lithuanian` + `regional_voice: lt-standard`.
...
**Locale techniques:** [locales/lithuanian.md](../techniques/locales/lithuanian.md) when use case matches.
