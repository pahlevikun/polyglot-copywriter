# it-it profile (summary)

**Language:** `italian` · **Overlay id:** `it-it`

Full rules: [languages/italian/overlays/it-it.md](../languages/italian/overlays/it-it.md).

Italian overlay — load when `regional_voice: it-it` or user names this region/variety.

**When to load:** `language: italian` + `regional_voice: it-it`.
