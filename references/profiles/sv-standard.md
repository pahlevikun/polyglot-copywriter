# sv-standard profile (summary)

**Language:** `swedish` · **Overlay id:** `sv-standard`

Full rules: [languages/swedish/overlays/sv-standard.md](../languages/swedish/overlays/sv-standard.md).

Swedish overlay — load when `regional_voice: sv-standard` or user names this region/variety.

**When to load:** `language: swedish` + `regional_voice: sv-standard`.
...
**Locale techniques:** [locales/swedish.md](../techniques/locales/swedish.md) when use case matches.
