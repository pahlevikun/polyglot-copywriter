# sl-si profile (summary)

**Language:** `slovenian` · **Overlay id:** `sl-si`

Full rules: [languages/slovenian/overlays/sl-si.md](../languages/slovenian/overlays/sl-si.md).

Slovenian overlay — load when `regional_voice: sl-si` or user names this region/variety.

**When to load:** `language: slovenian` + `regional_voice: sl-si`.
...
**Locale techniques:** [locales/slovenian.md](../techniques/locales/slovenian.md) when use case matches.
