# ms-bn profile (summary)

**Language:** `malay` · **Overlay id:** `ms-bn`

Full rules: [languages/malay/overlays/ms-bn.md](../languages/malay/overlays/ms-bn.md).

Malay overlay — load when `regional_voice: ms-bn` or user names this region/variety.

**When to load:** `language: malay` + `regional_voice: ms-bn`.
...
**Locale techniques:** [locales/malay.md](../techniques/locales/malay.md) when use case matches.
