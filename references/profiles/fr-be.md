# fr-be profile (summary)

**Language:** `french` · **Overlay id:** `fr-be`

Full rules: [languages/french/overlays/fr-be.md](../languages/french/overlays/fr-be.md).

French overlay — load when `regional_voice: fr-be` or user names this region/variety.

**When to load:** `language: french` + `regional_voice: fr-be`.
