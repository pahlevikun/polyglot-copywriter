# mn-standard profile (summary)

**Language:** `mongolian` · **Overlay id:** `mn-standard`

Full rules: [languages/mongolian/overlays/mn-standard.md](../languages/mongolian/overlays/mn-standard.md).

Mongolian overlay — load when `regional_voice: mn-standard` or user names this region/variety.

**When to load:** `language: mongolian` + `regional_voice: mn-standard`.
...
**Locale techniques:** [locales/mongolian.md](../techniques/locales/mongolian.md) when use case matches.
