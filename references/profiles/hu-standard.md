# hu-standard profile (summary)

**Language:** `hungarian` · **Overlay id:** `hu-standard`

Full rules: [languages/hungarian/overlays/hu-standard.md](../languages/hungarian/overlays/hu-standard.md).

Hungarian overlay — load when `regional_voice: hu-standard` or user names this region/variety.

**When to load:** `language: hungarian` + `regional_voice: hu-standard`.
...
**Locale techniques:** [locales/hungarian.md](../techniques/locales/hungarian.md) when use case matches.
