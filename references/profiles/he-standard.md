# he-standard profile (summary)

**Language:** `hebrew` · **Overlay id:** `he-standard`

Full rules: [languages/hebrew/overlays/he-standard.md](../languages/hebrew/overlays/he-standard.md).

Hebrew overlay — load when `regional_voice: he-standard` or user names this region/variety.

**When to load:** `language: hebrew` + `regional_voice: he-standard`.
...
**Locale techniques:** [locales/hebrew.md](../techniques/locales/hebrew.md) when use case matches.
