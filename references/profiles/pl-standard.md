# pl-standard profile (summary)

**Language:** `polish` · **Overlay id:** `pl-standard`

Full rules: [languages/polish/overlays/pl-standard.md](../languages/polish/overlays/pl-standard.md).

Polish overlay — load when `regional_voice: pl-standard` or user names this region/variety.

**When to load:** `language: polish` + `regional_voice: pl-standard`.
...
**Locale techniques:** [locales/polish.md](../techniques/locales/polish.md) when use case matches.
