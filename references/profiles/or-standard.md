# or-standard profile (summary)

**Language:** `odia` · **Overlay id:** `or-standard`

Full rules: [languages/odia/overlays/or-standard.md](../languages/odia/overlays/or-standard.md).

Odia overlay — load when `regional_voice: or-standard` or user names this region/variety.

**When to load:** `language: odia` + `regional_voice: or-standard`.
...
**Locale techniques:** [locales/odia.md](../techniques/locales/odia.md) when use case matches.
