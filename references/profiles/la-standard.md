# la-standard profile (summary)

**Language:** `latin` · **Overlay id:** `la-standard`

Full rules: [languages/latin/overlays/la-standard.md](../languages/latin/overlays/la-standard.md).

Latin overlay — load when `regional_voice: la-standard` or user names this region/variety.

**When to load:** `language: latin` + `regional_voice: la-standard`.
...
**Locale techniques:** [locales/latin.md](../techniques/locales/latin.md) when use case matches.
