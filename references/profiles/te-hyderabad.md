# te-hyderabad profile (summary)

**Language:** `telugu` · **Overlay id:** `te-hyderabad`

Full rules: [languages/telugu/overlays/te-hyderabad.md](../languages/telugu/overlays/te-hyderabad.md).

Telugu overlay — load when `regional_voice: te-hyderabad` or user names this region/variety.

**When to load:** `language: telugu` + `regional_voice: te-hyderabad`.
...
**Locale techniques:** [locales/telugu.md](../techniques/locales/telugu.md) when use case matches.
