# zh-sg profile (summary)

**Language:** `mandarin` · **Overlay id:** `zh-sg`

Full rules: [languages/mandarin/overlays/zh-sg.md](../languages/mandarin/overlays/zh-sg.md).

Mandarin Chinese overlay — load when `regional_voice: zh-sg` or user names this region/variety.

**When to load:** `language: mandarin` + `regional_voice: zh-sg`.
