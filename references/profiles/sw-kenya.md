# sw-kenya profile (summary)

**Language:** `swahili` · **Overlay id:** `sw-kenya`

Full rules: [languages/swahili/overlays/sw-kenya.md](../languages/swahili/overlays/sw-kenya.md).

Swahili overlay — load when `regional_voice: sw-kenya` or user names this region/variety.

**When to load:** `language: swahili` + `regional_voice: sw-kenya`.
