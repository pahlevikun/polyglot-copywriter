# abui-standard profile (summary)

**Language:** `abui` · **Overlay id:** `abui-standard`

Full rules: [languages/abui/overlays/abui-standard.md](../languages/abui/overlays/abui-standard.md).

Abui overlay — load when `regional_voice: abui-standard` or user names this region/variety.

**When to load:** `language: abui` + `regional_voice: abui-standard`.
...
**Locale techniques:** [locales/abui.md](../techniques/locales/abui.md) when use case matches.
