# da-standard profile (summary)

**Language:** `danish` · **Overlay id:** `da-standard`

Full rules: [languages/danish/overlays/da-standard.md](../languages/danish/overlays/da-standard.md).

Danish overlay — load when `regional_voice: da-standard` or user names this region/variety.

**When to load:** `language: danish` + `regional_voice: da-standard`.
...
**Locale techniques:** [locales/danish.md](../techniques/locales/danish.md) when use case matches.
