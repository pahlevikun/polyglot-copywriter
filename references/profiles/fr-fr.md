# fr-fr profile (summary)

**Language:** `french` · **Overlay id:** `fr-fr`

Full rules: [languages/french/overlays/fr-fr.md](../languages/french/overlays/fr-fr.md).

French overlay — load when `regional_voice: fr-fr` or user names this region/variety.

**When to load:** `language: french` + `regional_voice: fr-fr`.
...
**Locale techniques:** [locales/french.md](../techniques/locales/french.md) when use case matches.
