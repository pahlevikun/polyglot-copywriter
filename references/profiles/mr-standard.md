# mr-standard profile (summary)

**Language:** `marathi` · **Overlay id:** `mr-standard`

Full rules: [languages/marathi/overlays/mr-standard.md](../languages/marathi/overlays/mr-standard.md).

Marathi overlay — load when `regional_voice: mr-standard` or user names this region/variety.

**When to load:** `language: marathi` + `regional_voice: mr-standard`.
