# ph-en profile (summary)

**Language:** `english` · **Overlay id:** `ph-en`

Full rules: [languages/english/overlays/ph-en.md](../languages/english/overlays/ph-en.md).

English overlay — load when `regional_voice: ph-en` or user names this region/variety.

**When to load:** `language: english` + `regional_voice: ph-en`.
...
**Locale techniques:** [locales/english.md](../techniques/locales/english.md) when use case matches.
