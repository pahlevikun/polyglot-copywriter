# pa-pk profile (summary)

**Language:** `punjabi` · **Overlay id:** `pa-pk`

Full rules: [languages/punjabi/overlays/pa-pk.md](../languages/punjabi/overlays/pa-pk.md).

Punjabi overlay — load when `regional_voice: pa-pk` or user names this region/variety.

**When to load:** `language: punjabi` + `regional_voice: pa-pk`.
