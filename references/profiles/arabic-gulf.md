# arabic-gulf profile (summary)

**Language:** `arabic` · **Overlay id:** `arabic-gulf`

Full rules: [languages/arabic/overlays/arabic-gulf.md](../languages/arabic/overlays/arabic-gulf.md).

Arabic overlay — load when `regional_voice: arabic-gulf` or user names this region/variety.

**When to load:** `language: arabic` + `regional_voice: arabic-gulf`.
