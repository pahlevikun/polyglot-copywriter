# eo-standard profile (summary)

**Language:** `esperanto` · **Overlay id:** `eo-standard`

Full rules: [languages/esperanto/overlays/eo-standard.md](../languages/esperanto/overlays/eo-standard.md).

Esperanto overlay — load when `regional_voice: eo-standard` or user names this region/variety.

**When to load:** `language: esperanto` + `regional_voice: eo-standard`.
...
**Locale techniques:** [locales/esperanto.md](../techniques/locales/esperanto.md) when use case matches.
