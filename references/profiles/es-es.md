# es-es profile (summary)

**Language:** `spanish` · **Overlay id:** `es-es`

Full rules: [languages/spanish/overlays/es-es.md](../languages/spanish/overlays/es-es.md).

Spanish overlay — load when `regional_voice: es-es` or user names this region/variety.

**When to load:** `language: spanish` + `regional_voice: es-es`.
