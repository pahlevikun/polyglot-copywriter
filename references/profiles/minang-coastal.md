# minang-coastal profile (summary)

**Language:** `minangkabau` · **Overlay id:** `minang-coastal`

Full rules: [languages/minangkabau/overlays/minang-coastal.md](../languages/minangkabau/overlays/minang-coastal.md).

Minangkabau overlay — load when `regional_voice: minang-coastal` or user names this region/variety.

**When to load:** `language: minangkabau` + `regional_voice: minang-coastal`.
...
**Locale techniques:** [locales/minangkabau.md](../techniques/locales/minangkabau.md) when use case matches.
