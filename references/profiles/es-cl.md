# es-cl profile (summary)

**Language:** `spanish` · **Overlay id:** `es-cl`

Full rules: [languages/spanish/overlays/es-cl.md](../languages/spanish/overlays/es-cl.md).

Spanish overlay — load when `regional_voice: es-cl` or user names this region/variety.

**When to load:** `language: spanish` + `regional_voice: es-cl`.
