...
**Language:** `english` · **Overlay id:** `za`

Full rules: [languages/english/overlays/za.md](../languages/english/overlays/za.md).

English overlay — load when `regional_voice: za` or user names this region/variety.

**When to load:** `language: english` + `regional_voice: za`.
