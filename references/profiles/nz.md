...
**Language:** `english` · **Overlay id:** `nz`

Full rules: [languages/english/overlays/nz.md](../languages/english/overlays/nz.md).

English overlay — load when `regional_voice: nz` or user names this region/variety.

**When to load:** `language: english` + `regional_voice: nz`.
