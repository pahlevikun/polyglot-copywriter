# tohoku profile (summary)

**Language:** `japanese` · **Overlay id:** `tohoku`

Full rules: [languages/japanese/overlays/tohoku.md](../languages/japanese/overlays/tohoku.md).

Japanese overlay — load when `regional_voice: tohoku` or user names this region/variety.

**When to load:** `language: japanese` + `regional_voice: tohoku`.
...
**Locale techniques:** [locales/japanese.md](../techniques/locales/japanese.md) when use case matches.
