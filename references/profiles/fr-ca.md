# fr-ca profile (summary)

**Language:** `french` · **Overlay id:** `fr-ca`

Full rules: [languages/french/overlays/fr-ca.md](../languages/french/overlays/fr-ca.md).

French overlay — load when `regional_voice: fr-ca` or user names this region/variety.

**When to load:** `language: french` + `regional_voice: fr-ca`.
