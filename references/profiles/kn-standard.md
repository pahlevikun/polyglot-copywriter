# kn-standard profile (summary)

**Language:** `kannada` · **Overlay id:** `kn-standard`

Full rules: [languages/kannada/overlays/kn-standard.md](../languages/kannada/overlays/kn-standard.md).

Kannada overlay — load when `regional_voice: kn-standard` or user names this region/variety.

**When to load:** `language: kannada` + `regional_voice: kn-standard`.
...
**Locale techniques:** [locales/kannada.md](../techniques/locales/kannada.md) when use case matches.
