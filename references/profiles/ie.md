...
**Language:** `english` · **Overlay id:** `ie`

Full rules: [languages/english/overlays/ie.md](../languages/english/overlays/ie.md).

English overlay — load when `regional_voice: ie` or user names this region/variety.

**When to load:** `language: english` + `regional_voice: ie`.
