# pt-br profile (summary)

**Language:** `portuguese` · **Overlay id:** `pt-br`

Full rules: [languages/portuguese/overlays/pt-br.md](../languages/portuguese/overlays/pt-br.md).

Portuguese overlay — load when `regional_voice: pt-br` or user names this region/variety.

**When to load:** `language: portuguese` + `regional_voice: pt-br`.
...
**Locale techniques:** [locales/portuguese.md](../techniques/locales/portuguese.md) when use case matches.
