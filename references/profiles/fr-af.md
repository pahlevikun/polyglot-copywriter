# fr-af profile (summary)

**Language:** `french` · **Overlay id:** `fr-af`

Full rules: [languages/french/overlays/fr-af.md](../languages/french/overlays/fr-af.md).

French overlay — load when `regional_voice: fr-af` or user names this region/variety.

**When to load:** `language: french` + `regional_voice: fr-af`.
