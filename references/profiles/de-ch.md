# de-ch profile (summary)

**Language:** `german` · **Overlay id:** `de-ch`

Full rules: [languages/german/overlays/de-ch.md](../languages/german/overlays/de-ch.md).

German overlay — load when `regional_voice: de-ch` or user names this region/variety.

**When to load:** `language: german` + `regional_voice: de-ch`.
