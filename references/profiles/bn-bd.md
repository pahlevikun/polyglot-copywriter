# bn-bd profile (summary)

**Language:** `bengali` · **Overlay id:** `bn-bd`

Full rules: [languages/bengali/overlays/bn-bd.md](../languages/bengali/overlays/bn-bd.md).

Bengali overlay — load when `regional_voice: bn-bd` or user names this region/variety.

**When to load:** `language: bengali` + `regional_voice: bn-bd`.
