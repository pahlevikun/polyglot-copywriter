# yue-hk profile (summary)

**Language:** `cantonese` · **Overlay id:** `yue-hk`

Full rules: [languages/cantonese/overlays/yue-hk.md](../languages/cantonese/overlays/yue-hk.md).

Cantonese overlay — load when `regional_voice: yue-hk` or user names this region/variety.

**When to load:** `language: cantonese` + `regional_voice: yue-hk`.
...
**Locale techniques:** [locales/cantonese.md](../techniques/locales/cantonese.md) when use case matches.
