# sw-tanzania profile (summary)

**Language:** `swahili` · **Overlay id:** `sw-tanzania`

Full rules: [languages/swahili/overlays/sw-tanzania.md](../languages/swahili/overlays/sw-tanzania.md).

Swahili overlay — load when `regional_voice: sw-tanzania` or user names this region/variety.

**When to load:** `language: swahili` + `regional_voice: sw-tanzania`.
...
**Locale techniques:** [locales/swahili.md](../techniques/locales/swahili.md) when use case matches.
