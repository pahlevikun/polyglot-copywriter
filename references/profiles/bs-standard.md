# bs-standard profile (summary)

**Language:** `bosnian` · **Overlay id:** `bs-standard`

Full rules: [languages/bosnian/overlays/bs-standard.md](../languages/bosnian/overlays/bs-standard.md).

Bosnian overlay — load when `regional_voice: bs-standard` or user names this region/variety.

**When to load:** `language: bosnian` + `regional_voice: bs-standard`.
...
**Locale techniques:** [locales/bosnian.md](../techniques/locales/bosnian.md) when use case matches.
