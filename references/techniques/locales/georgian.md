# Georgian locale techniques

Load when **`language` is `georgian`**. Base: [languages/georgian/pack.md](../../languages/georgian/pack.md), [culture.md](../../languages/georgian/culture.md). Overlays under [languages/georgian/overlays/](../../languages/georgian/overlays/).
