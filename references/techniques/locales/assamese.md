# Assamese locale techniques

Load when **`language` is `assamese`**. Base: [languages/assamese/pack.md](../../languages/assamese/pack.md), [culture.md](../../languages/assamese/culture.md). Overlays under [languages/assamese/overlays/](../../languages/assamese/overlays/).
