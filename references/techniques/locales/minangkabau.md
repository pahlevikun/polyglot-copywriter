# Minangkabau locale techniques

Load when **`language` is `minangkabau`**. Base: [languages/minangkabau/pack.md](../../languages/minangkabau/pack.md), [culture.md](../../languages/minangkabau/culture.md). Overlays under [languages/minangkabau/overlays/](../../languages/minangkabau/overlays/).

**Transcreation** — Limited pack — stay within documented overlays.
