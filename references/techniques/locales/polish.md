# Polish locale techniques

Load when **`language` is `polish`**. Base: [languages/polish/pack.md](../../languages/polish/pack.md), [culture.md](../../languages/polish/culture.md). Overlays under [languages/polish/overlays/](../../languages/polish/overlays/).
