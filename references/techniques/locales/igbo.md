# Igbo locale techniques

Load when **`language` is `igbo`**. Base: [languages/igbo/pack.md](../../languages/igbo/pack.md), [culture.md](../../languages/igbo/culture.md). Overlays under [languages/igbo/overlays/](../../languages/igbo/overlays/).
