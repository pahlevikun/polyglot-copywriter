# Zulu locale techniques

Load when **`language` is `zulu`**. Base: [languages/zulu/pack.md](../../languages/zulu/pack.md), [culture.md](../../languages/zulu/culture.md). Overlays under [languages/zulu/overlays/](../../languages/zulu/overlays/).
