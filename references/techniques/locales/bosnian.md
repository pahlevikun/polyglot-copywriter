# Bosnian locale techniques

Load when **`language` is `bosnian`**. Base: [languages/bosnian/pack.md](../../languages/bosnian/pack.md), [culture.md](../../languages/bosnian/culture.md). Overlays under [languages/bosnian/overlays/](../../languages/bosnian/overlays/).
