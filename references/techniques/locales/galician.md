# Galician locale techniques

Load when **`language` is `galician`**. Base: [languages/galician/pack.md](../../languages/galician/pack.md), [culture.md](../../languages/galician/culture.md). Overlays under [languages/galician/overlays/](../../languages/galician/overlays/).
