# Basque locale techniques

Load when **`language` is `basque`**. Base: [languages/basque/pack.md](../../languages/basque/pack.md), [culture.md](../../languages/basque/culture.md). Overlays under [languages/basque/overlays/](../../languages/basque/overlays/).
