# Thai locale techniques

Load when **`language` is `thai`**. Base: [languages/thai/pack.md](../../languages/thai/pack.md), [culture.md](../../languages/thai/culture.md). Overlays under [languages/thai/overlays/](../../languages/thai/overlays/).
