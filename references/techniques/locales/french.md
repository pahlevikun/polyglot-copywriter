# French locale techniques

Load when **`language` is `french`**. Base: [languages/french/pack.md](../../languages/french/pack.md), [culture.md](../../languages/french/culture.md). Overlays under [languages/french/overlays/](../../languages/french/overlays/).
