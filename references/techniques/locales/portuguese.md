# Portuguese locale techniques

Load when **`language` is `portuguese`**. Base: [languages/portuguese/pack.md](../../languages/portuguese/pack.md), [culture.md](../../languages/portuguese/culture.md). Overlays under [languages/portuguese/overlays/](../../languages/portuguese/overlays/).
