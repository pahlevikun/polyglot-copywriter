# Odia locale techniques

Load when **`language` is `odia`**. Base: [languages/odia/pack.md](../../languages/odia/pack.md), [culture.md](../../languages/odia/culture.md). Overlays under [languages/odia/overlays/](../../languages/odia/overlays/).
