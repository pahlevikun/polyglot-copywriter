# Hausa locale techniques

Load when **`language` is `hausa`**. Base: [languages/hausa/pack.md](../../languages/hausa/pack.md), [culture.md](../../languages/hausa/culture.md). Overlays under [languages/hausa/overlays/](../../languages/hausa/overlays/).
