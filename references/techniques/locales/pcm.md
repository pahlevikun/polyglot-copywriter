# Nigerian Pidgin locale techniques

Load when **`language` is `pcm`**. Base: [languages/pcm/pack.md](../../languages/pcm/pack.md), [culture.md](../../languages/pcm/culture.md). Overlays under [languages/pcm/overlays/](../../languages/pcm/overlays/).
