# Lao locale techniques

Load when **`language` is `lao`**. Base: [languages/lao/pack.md](../../languages/lao/pack.md), [culture.md](../../languages/lao/culture.md). Overlays under [languages/lao/overlays/](../../languages/lao/overlays/).
