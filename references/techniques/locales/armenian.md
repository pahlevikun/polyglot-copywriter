# Armenian locale techniques

Load when **`language` is `armenian`**. Base: [languages/armenian/pack.md](../../languages/armenian/pack.md), [culture.md](../../languages/armenian/culture.md). Overlays under [languages/armenian/overlays/](../../languages/armenian/overlays/).
