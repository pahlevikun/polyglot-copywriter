# Danish locale techniques

Load when **`language` is `danish`**. Base: [languages/danish/pack.md](../../languages/danish/pack.md), [culture.md](../../languages/danish/culture.md). Overlays under [languages/danish/overlays/](../../languages/danish/overlays/).
