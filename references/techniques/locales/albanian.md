# Albanian locale techniques

Load when **`language` is `albanian`**. Base: [languages/albanian/pack.md](../../languages/albanian/pack.md), [culture.md](../../languages/albanian/culture.md). Overlays under [languages/albanian/overlays/](../../languages/albanian/overlays/).
