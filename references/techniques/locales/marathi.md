# Marathi locale techniques

Load when **`language` is `marathi`**. Base: [languages/marathi/pack.md](../../languages/marathi/pack.md), [culture.md](../../languages/marathi/culture.md). Overlays under [languages/marathi/overlays/](../../languages/marathi/overlays/).
