# Slovenian locale techniques

Load when **`language` is `slovenian`**. Base: [languages/slovenian/pack.md](../../languages/slovenian/pack.md), [culture.md](../../languages/slovenian/culture.md). Overlays under [languages/slovenian/overlays/](../../languages/slovenian/overlays/).
