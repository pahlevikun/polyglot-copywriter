# Pashto locale techniques

Load when **`language` is `pashto`**. Base: [languages/pashto/pack.md](../../languages/pashto/pack.md), [culture.md](../../languages/pashto/culture.md). Overlays under [languages/pashto/overlays/](../../languages/pashto/overlays/).
