# Mandarin Chinese locale techniques

Load when **`language` is `mandarin`**. Base: [languages/mandarin/pack.md](../../languages/mandarin/pack.md), [culture.md](../../languages/mandarin/culture.md). Overlays under [languages/mandarin/overlays/](../../languages/mandarin/overlays/).
