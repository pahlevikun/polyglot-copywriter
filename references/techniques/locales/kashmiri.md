# Kashmiri locale techniques

Load when **`language` is `kashmiri`**. Base: [languages/kashmiri/pack.md](../../languages/kashmiri/pack.md), [culture.md](../../languages/kashmiri/culture.md). Overlays under [languages/kashmiri/overlays/](../../languages/kashmiri/overlays/).

**Transcreation** — Limited coverage — conservative standard; ask script/dialect if unclear.
