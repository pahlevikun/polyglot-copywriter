# Hebrew locale techniques

Load when **`language` is `hebrew`**. Base: [languages/hebrew/pack.md](../../languages/hebrew/pack.md), [culture.md](../../languages/hebrew/culture.md). Overlays under [languages/hebrew/overlays/](../../languages/hebrew/overlays/).
