# Burmese locale techniques

Load when **`language` is `burmese`**. Base: [languages/burmese/pack.md](../../languages/burmese/pack.md), [culture.md](../../languages/burmese/culture.md). Overlays under [languages/burmese/overlays/](../../languages/burmese/overlays/).
