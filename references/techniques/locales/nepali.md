# Nepali locale techniques

Load when **`language` is `nepali`**. Base: [languages/nepali/pack.md](../../languages/nepali/pack.md), [culture.md](../../languages/nepali/culture.md). Overlays under [languages/nepali/overlays/](../../languages/nepali/overlays/).
