# Azerbaijani locale techniques

Load when **`language` is `azerbaijani`**. Base: [languages/azerbaijani/pack.md](../../languages/azerbaijani/pack.md), [culture.md](../../languages/azerbaijani/culture.md). Overlays under [languages/azerbaijani/overlays/](../../languages/azerbaijani/overlays/).
