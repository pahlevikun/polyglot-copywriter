# Tagalog locale techniques

Load when **`language` is `tagalog`**. Base: [languages/tagalog/pack.md](../../languages/tagalog/pack.md), [culture.md](../../languages/tagalog/culture.md). Overlays under [languages/tagalog/overlays/](../../languages/tagalog/overlays/).
