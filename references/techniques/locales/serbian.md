# Serbian locale techniques

Load when **`language` is `serbian`**. Base: [languages/serbian/pack.md](../../languages/serbian/pack.md), [culture.md](../../languages/serbian/culture.md). Overlays under [languages/serbian/overlays/](../../languages/serbian/overlays/).
