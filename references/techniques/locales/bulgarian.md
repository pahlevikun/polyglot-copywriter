# Bulgarian locale techniques

Load when **`language` is `bulgarian`**. Base: [languages/bulgarian/pack.md](../../languages/bulgarian/pack.md), [culture.md](../../languages/bulgarian/culture.md). Overlays under [languages/bulgarian/overlays/](../../languages/bulgarian/overlays/).
