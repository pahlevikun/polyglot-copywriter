# Mongolian locale techniques

Load when **`language` is `mongolian`**. Base: [languages/mongolian/pack.md](../../languages/mongolian/pack.md), [culture.md](../../languages/mongolian/culture.md). Overlays under [languages/mongolian/overlays/](../../languages/mongolian/overlays/).
