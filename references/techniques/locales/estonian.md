# Estonian locale techniques

Load when **`language` is `estonian`**. Base: [languages/estonian/pack.md](../../languages/estonian/pack.md), [culture.md](../../languages/estonian/culture.md). Overlays under [languages/estonian/overlays/](../../languages/estonian/overlays/).
