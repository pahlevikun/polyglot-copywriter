# Latvian locale techniques

Load when **`language` is `latvian`**. Base: [languages/latvian/pack.md](../../languages/latvian/pack.md), [culture.md](../../languages/latvian/culture.md). Overlays under [languages/latvian/overlays/](../../languages/latvian/overlays/).
