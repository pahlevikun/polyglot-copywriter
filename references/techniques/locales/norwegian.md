# Norwegian locale techniques

Load when **`language` is `norwegian`**. Base: [languages/norwegian/pack.md](../../languages/norwegian/pack.md), [culture.md](../../languages/norwegian/culture.md). Overlays under [languages/norwegian/overlays/](../../languages/norwegian/overlays/).
