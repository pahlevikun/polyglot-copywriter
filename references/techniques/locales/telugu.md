# Telugu locale techniques

Load when **`language` is `telugu`**. Base: [languages/telugu/pack.md](../../languages/telugu/pack.md), [culture.md](../../languages/telugu/culture.md). Overlays under [languages/telugu/overlays/](../../languages/telugu/overlays/).
