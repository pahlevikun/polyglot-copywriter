# Romanian locale techniques

Load when **`language` is `romanian`**. Base: [languages/romanian/pack.md](../../languages/romanian/pack.md), [culture.md](../../languages/romanian/culture.md). Overlays under [languages/romanian/overlays/](../../languages/romanian/overlays/).
