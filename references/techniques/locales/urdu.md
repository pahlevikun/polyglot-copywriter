# Urdu locale techniques

Load when **`language` is `urdu`**. Base: [languages/urdu/pack.md](../../languages/urdu/pack.md), [culture.md](../../languages/urdu/culture.md). Overlays under [languages/urdu/overlays/](../../languages/urdu/overlays/).
