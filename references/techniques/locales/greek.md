# Greek locale techniques

Load when **`language` is `greek`**. Base: [languages/greek/pack.md](../../languages/greek/pack.md), [culture.md](../../languages/greek/culture.md). Overlays under [languages/greek/overlays/](../../languages/greek/overlays/).
