# Sinhala locale techniques

Load when **`language` is `sinhala`**. Base: [languages/sinhala/pack.md](../../languages/sinhala/pack.md), [culture.md](../../languages/sinhala/culture.md). Overlays under [languages/sinhala/overlays/](../../languages/sinhala/overlays/).
