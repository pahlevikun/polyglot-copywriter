# Vietnamese locale techniques

Load when **`language` is `vietnamese`**. Base: [languages/vietnamese/pack.md](../../languages/vietnamese/pack.md), [culture.md](../../languages/vietnamese/culture.md). Overlays under [languages/vietnamese/overlays/](../../languages/vietnamese/overlays/).
