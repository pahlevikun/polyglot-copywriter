# Hungarian locale techniques

Load when **`language` is `hungarian`**. Base: [languages/hungarian/pack.md](../../languages/hungarian/pack.md), [culture.md](../../languages/hungarian/culture.md). Overlays under [languages/hungarian/overlays/](../../languages/hungarian/overlays/).
