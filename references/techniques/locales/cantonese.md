# Cantonese locale techniques

Load when **`language` is `cantonese`**. Base: [languages/cantonese/pack.md](../../languages/cantonese/pack.md), [culture.md](../../languages/cantonese/culture.md). Overlays under [languages/cantonese/overlays/](../../languages/cantonese/overlays/).

**Transcreation** — Separate from mandarin — Yue/Cantonese grammar and lexicon.
...
- Separate from mandarin — Yue/Cantonese grammar and lexicon.
