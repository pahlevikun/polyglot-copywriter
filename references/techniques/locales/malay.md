# Malay locale techniques

Load when **`language` is `malay`**. Base: [languages/malay/pack.md](../../languages/malay/pack.md), [culture.md](../../languages/malay/culture.md). Overlays under [languages/malay/overlays/](../../languages/malay/overlays/).
