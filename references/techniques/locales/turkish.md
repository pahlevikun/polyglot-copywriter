# Turkish locale techniques

Load when **`language` is `turkish`**. Base: [languages/turkish/pack.md](../../languages/turkish/pack.md), [culture.md](../../languages/turkish/culture.md). Overlays under [languages/turkish/overlays/](../../languages/turkish/overlays/).
