# Somali locale techniques

Load when **`language` is `somali`**. Base: [languages/somali/pack.md](../../languages/somali/pack.md), [culture.md](../../languages/somali/culture.md). Overlays under [languages/somali/overlays/](../../languages/somali/overlays/).
