# Spanish locale techniques

Load when **`language` is `spanish`**. Base: [languages/spanish/pack.md](../../languages/spanish/pack.md), [culture.md](../../languages/spanish/culture.md). Overlays under [languages/spanish/overlays/](../../languages/spanish/overlays/).
