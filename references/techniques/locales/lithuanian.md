# Lithuanian locale techniques

Load when **`language` is `lithuanian`**. Base: [languages/lithuanian/pack.md](../../languages/lithuanian/pack.md), [culture.md](../../languages/lithuanian/culture.md). Overlays under [languages/lithuanian/overlays/](../../languages/lithuanian/overlays/).
