# Kannada locale techniques

Load when **`language` is `kannada`**. Base: [languages/kannada/pack.md](../../languages/kannada/pack.md), [culture.md](../../languages/kannada/culture.md). Overlays under [languages/kannada/overlays/](../../languages/kannada/overlays/).
