# Sindhi locale techniques

Load when **`language` is `sindhi`**. Base: [languages/sindhi/pack.md](../../languages/sindhi/pack.md), [culture.md](../../languages/sindhi/culture.md). Overlays under [languages/sindhi/overlays/](../../languages/sindhi/overlays/).
