...
Standard Odia pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Odia maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Odia sentence.

## What casual is not

- Not English sentence with one Odia word
