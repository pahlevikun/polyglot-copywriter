...
**Status:** `validated`. Write as a careful coworker in Odia; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Odia; load overlay `odia` default when region unspecified.
