# ml-standard — Malayalam standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: malayalam` + `regional_voice: ml-standard`. Default overlay for Malayalam.
...
- Standard Malayalam orthography; no dialect caricature.
