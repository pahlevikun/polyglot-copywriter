# Pashto — language pack

**Status:** `validated`. Write as a careful coworker in Pashto; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Pashto; load overlay `pashto` default when region unspecified.
