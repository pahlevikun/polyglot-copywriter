...
Standard Pashto pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Pashto maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Pashto sentence.

## What casual is not

- Not English sentence with one Pashto word
