...
**Status:** `validated`. Write as a careful coworker in Nepali; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Nepali; load overlay `nepali` default when region unspecified.
