...
Standard Nepali pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Nepali maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Nepali sentence.

## What casual is not

- Not English sentence with one Nepali word
