...
**Status:** `validated`. Write as a careful coworker in Uzbek; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Uzbek; load overlay `uzbek` default when region unspecified.
