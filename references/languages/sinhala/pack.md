...
**Status:** `validated`. Write as a careful coworker in Sinhala; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Sinhala; load overlay `sinhala` default when region unspecified.
