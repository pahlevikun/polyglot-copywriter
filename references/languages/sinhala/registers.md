...
Standard Sinhala pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Sinhala maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Sinhala sentence.

## What casual is not

- Not English sentence with one Sinhala word
