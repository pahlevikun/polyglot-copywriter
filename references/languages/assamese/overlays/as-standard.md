# as-standard — Assamese standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: assamese` + `regional_voice: as-standard`. Default overlay for Assamese.
...
- Standard Assamese orthography; no dialect caricature.
