...
Standard Assamese pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Assamese maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Assamese sentence.

## What casual is not

- Not English sentence with one Assamese word
