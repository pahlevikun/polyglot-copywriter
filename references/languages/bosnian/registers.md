...
Standard Bosnian pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Bosnian maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Bosnian sentence.

## What casual is not

- Not English sentence with one Bosnian word
