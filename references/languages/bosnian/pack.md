...
**Status:** `validated`. Write as a careful coworker in Bosnian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Bosnian; load overlay `bosnian` default when region unspecified.
