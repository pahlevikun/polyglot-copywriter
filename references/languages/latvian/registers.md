...
Standard Latvian pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Latvian maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Latvian sentence.

## What casual is not

- Not English sentence with one Latvian word
