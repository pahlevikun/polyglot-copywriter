# bg-standard — Bulgarian standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: bulgarian` + `regional_voice: bg-standard`. Default overlay for Bulgarian.
...
- Standard Bulgarian orthography; no dialect caricature.
