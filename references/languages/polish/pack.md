...
**Status:** `validated`. Write as a careful coworker in Polish; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Polish; load overlay `polish` default when region unspecified.
