...
**Status:** `validated`. Write as a careful coworker in Estonian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Estonian; load overlay `estonian` default when region unspecified.
