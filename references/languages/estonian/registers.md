...
Standard Estonian pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Estonian maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Estonian sentence.

## What casual is not

- Not English sentence with one Estonian word
