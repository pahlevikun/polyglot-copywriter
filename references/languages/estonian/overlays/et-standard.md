# et-standard — Estonian standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: estonian` + `regional_voice: et-standard`. Default overlay for Estonian.
...
- Standard Estonian orthography; no dialect caricature.
