# sq-standard — Albanian standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: albanian` + `regional_voice: sq-standard`. Default overlay for Albanian.
...
- Standard Albanian orthography; no dialect caricature.
