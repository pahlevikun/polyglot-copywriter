...
Standard Slovak pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Slovak maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Slovak sentence.

## What casual is not

- Not English sentence with one Slovak word
