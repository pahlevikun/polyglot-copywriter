...
Standard Guarani pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Guarani maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Guarani sentence.

## What casual is not

- Not English sentence with one Guarani word
