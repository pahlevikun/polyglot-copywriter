...
**Status:** `validated`. Write as a careful coworker in Danish; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Danish; load overlay `danish` default when region unspecified.
