...
Standard Danish pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Danish maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Danish sentence.

## What casual is not

- Not English sentence with one Danish word
