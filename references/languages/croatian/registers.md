...
Standard Croatian pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Croatian maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Croatian sentence.

## What casual is not

- Not English sentence with one Croatian word
