# hr-standard — Croatian standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: croatian` + `regional_voice: hr-standard`. Default overlay for Croatian.
...
- Standard Croatian orthography; no dialect caricature.
