...
**Status:** `validated`. Write as a careful coworker in Croatian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Croatian; load overlay `croatian` default when region unspecified.
