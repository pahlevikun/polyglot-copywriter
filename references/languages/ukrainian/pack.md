...
**Status:** `validated`. Write as a careful coworker in Ukrainian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Ukrainian; load overlay `ukrainian` default when region unspecified.
