...
**Status:** `validated`. Write as a careful coworker in Thai; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Thai; load overlay `thai` default when region unspecified.
