...
**Status:** `validated`. Write as a careful coworker in Amharic; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Amharic; load overlay `amharic` default when region unspecified.
