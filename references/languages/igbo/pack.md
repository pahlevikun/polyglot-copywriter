...
**Status:** `validated`. Write as a careful coworker in Igbo; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Igbo; load overlay `igbo` default when region unspecified.
