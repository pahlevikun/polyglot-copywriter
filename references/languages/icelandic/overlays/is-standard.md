# is-standard — Icelandic standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: icelandic` + `regional_voice: is-standard`. Default overlay for Icelandic.
...
- Standard Icelandic orthography; no dialect caricature.
