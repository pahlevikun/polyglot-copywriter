# eo-standard — Esperanto standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: esperanto` + `regional_voice: eo-standard`. Default overlay for Esperanto.
...
- Standard Esperanto orthography; no dialect caricature.
