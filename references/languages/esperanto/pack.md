...
**Status:** `validated`. Write as a careful coworker in Esperanto; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Esperanto; load overlay `esperanto` default when region unspecified.
