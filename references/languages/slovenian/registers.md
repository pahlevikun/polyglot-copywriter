...
Standard Slovenian pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Slovenian maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Slovenian sentence.

## What casual is not

- Not English sentence with one Slovenian word
