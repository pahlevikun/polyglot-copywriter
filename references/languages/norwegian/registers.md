...
Standard Norwegian pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Norwegian maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Norwegian sentence.

## What casual is not

- Not English sentence with one Norwegian word
