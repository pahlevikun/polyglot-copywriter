...
**Status:** `validated`. Write as a careful coworker in Norwegian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Norwegian; load overlay `norwegian` default when region unspecified.
