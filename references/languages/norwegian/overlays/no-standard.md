# no-standard — Norwegian standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: norwegian` + `regional_voice: no-standard`. Default overlay for Norwegian.
...
- Standard Norwegian orthography; no dialect caricature.
