...
**Status:** `validated`. Write as a careful coworker in Azerbaijani; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Azerbaijani; load overlay `azerbaijani` default when region unspecified.
