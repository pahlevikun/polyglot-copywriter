# azerbaijani culture and transcreation
...
|---|---|---|
| Work email | Formal/respectful second person | Default respectful |
| Peer chat | Informal second person when user already casual | Only when user already casual |
