# az-standard — Azerbaijani standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: azerbaijani` + `regional_voice: az-standard`. Default overlay for Azerbaijani.
...
- Standard Azerbaijani orthography; no dialect caricature.
