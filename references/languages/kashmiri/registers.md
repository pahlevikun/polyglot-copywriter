...
Standard Kashmiri pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Kashmiri maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Kashmiri sentence.

## What casual is not

- Not English sentence with one Kashmiri word
