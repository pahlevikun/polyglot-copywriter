# ks-standard — Kashmiri standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: kashmiri` + `regional_voice: ks-standard`. Default overlay for Kashmiri.
...
- Standard Kashmiri orthography; no dialect caricature.
