...
**Status:** `validated`. Write as a careful coworker in Gujarati; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Gujarati; load overlay `gujarati` default when region unspecified.
