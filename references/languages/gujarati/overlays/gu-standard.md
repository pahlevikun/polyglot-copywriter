# gu-standard — Gujarati standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: gujarati` + `regional_voice: gu-standard`. Default overlay for Gujarati.
...
- Standard Gujarati orthography; no dialect caricature.
