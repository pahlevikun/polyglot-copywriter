...
Standard Kannada pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Kannada maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Kannada sentence.

## What casual is not

- Not English sentence with one Kannada word
