...
Standard Sindhi pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Sindhi maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Sindhi sentence.

## What casual is not

- Not English sentence with one Sindhi word
