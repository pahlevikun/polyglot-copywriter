...
Standard Czech pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Czech maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Czech sentence.

## What casual is not

- Not English sentence with one Czech word
