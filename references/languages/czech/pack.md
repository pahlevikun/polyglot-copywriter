...
**Status:** `validated`. Write as a careful coworker in Czech; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Czech; load overlay `czech` default when region unspecified.
