# ro-standard — Romanian standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: romanian` + `regional_voice: ro-standard`. Default overlay for Romanian.
...
- Standard Romanian orthography; no dialect caricature.
