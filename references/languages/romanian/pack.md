...
**Status:** `validated`. Write as a careful coworker in Romanian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Romanian; load overlay `romanian` default when region unspecified.
