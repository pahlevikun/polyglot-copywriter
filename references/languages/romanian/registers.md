...
Standard Romanian pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Romanian maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Romanian sentence.

## What casual is not

- Not English sentence with one Romanian word
