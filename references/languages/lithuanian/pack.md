...
**Status:** `validated`. Write as a careful coworker in Lithuanian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Lithuanian; load overlay `lithuanian` default when region unspecified.
