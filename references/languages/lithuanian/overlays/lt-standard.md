# lt-standard — Lithuanian standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: lithuanian` + `regional_voice: lt-standard`. Default overlay for Lithuanian.
...
- Standard Lithuanian orthography; no dialect caricature.
