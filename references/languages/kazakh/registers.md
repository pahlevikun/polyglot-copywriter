...
Standard Kazakh pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Kazakh maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Kazakh sentence.

## What casual is not

- Not English sentence with one Kazakh word
