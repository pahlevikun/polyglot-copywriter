...
**Status:** `validated`. Write as a careful coworker in Kazakh; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Kazakh; load overlay `kazakh` default when region unspecified.
