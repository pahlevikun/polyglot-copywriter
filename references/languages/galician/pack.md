...
**Status:** `validated`. Write as a careful coworker in Galician; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Galician; load overlay `galician` default when region unspecified.
