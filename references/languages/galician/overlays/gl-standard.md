# gl-standard — Galician standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: galician` + `regional_voice: gl-standard`. Default overlay for Galician.
...
- Standard Galician orthography; no dialect caricature.
