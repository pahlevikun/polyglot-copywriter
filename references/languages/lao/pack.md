...
**Status:** `validated`. Write as a careful coworker in Lao; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Lao; load overlay `lao` default when region unspecified.
