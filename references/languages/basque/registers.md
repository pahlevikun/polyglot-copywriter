...
Standard Basque pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Basque maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Basque sentence.

## What casual is not

- Not English sentence with one Basque word
