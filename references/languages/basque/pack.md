...
**Status:** `validated`. Write as a careful coworker in Basque; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Basque; load overlay `basque` default when region unspecified.
