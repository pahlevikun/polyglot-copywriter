...
**Status:** `validated`. Write as a careful coworker in Burmese; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Burmese; load overlay `burmese` default when region unspecified.
