...
Standard Hungarian pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Hungarian maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Hungarian sentence.

## What casual is not

- Not English sentence with one Hungarian word
