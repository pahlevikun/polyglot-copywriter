# Mongolian — language pack

**Status:** `validated`. Write as a careful coworker in Mongolian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Mongolian; load overlay `mongolian` default when region unspecified.
