# mn-standard — Mongolian standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: mongolian` + `regional_voice: mn-standard`. Default overlay for Mongolian.
...
- Standard Mongolian orthography; no dialect caricature.
