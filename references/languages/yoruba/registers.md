...
Standard Yoruba pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Yoruba maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Yoruba sentence.

## What casual is not

- Not English sentence with one Yoruba word
