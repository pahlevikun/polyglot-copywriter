# hy-standard — Armenian standard

**Type:** `regional` | **Status:** `validated`

## When to load

`language: armenian` + `regional_voice: hy-standard`. Default overlay for Armenian.
...
- Standard Armenian orthography; no dialect caricature.
