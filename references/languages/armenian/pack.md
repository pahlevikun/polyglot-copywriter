# Armenian — language pack

**Status:** `validated`. Write as a careful coworker in Armenian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Armenian; load overlay `armenian` default when region unspecified.
