...
**Status:** `validated`. Write as a careful coworker in Welsh; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Welsh; load overlay `welsh` default when region unspecified.
