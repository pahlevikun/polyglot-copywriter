...
Standard Welsh pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Welsh maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Welsh sentence.

## What casual is not

- Not English sentence with one Welsh word
