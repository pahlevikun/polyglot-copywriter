...
Standard Somali pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Somali maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Somali sentence.

## What casual is not

- Not English sentence with one Somali word
