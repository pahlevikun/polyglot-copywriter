...
**Status:** `validated`. Write as a careful coworker in Hebrew; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Hebrew; load overlay `hebrew` default when region unspecified.
