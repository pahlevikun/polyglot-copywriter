...
Standard Zulu pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Zulu maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Zulu sentence.

## What casual is not

- Not English sentence with one Zulu word
