...
**Status:** `validated`. Write as a careful coworker in Greek; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Greek; load overlay `greek` default when region unspecified.
