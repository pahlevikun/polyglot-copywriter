...
Standard Georgian pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Georgian maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Georgian sentence.

## What casual is not

- Not English sentence with one Georgian word
