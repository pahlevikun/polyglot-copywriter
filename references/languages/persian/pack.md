...
**Status:** `validated`. Write as a careful coworker in Persian; **not** Farhan fingerprint unless user asked English/Indonesian.
...
Standard Persian; load overlay `persian` default when region unspecified.
