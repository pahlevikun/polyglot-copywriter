...
Standard Swedish pronouns — formal for external work; casual only when user set tone.

## Examples

### `baku` (formal)

- **Good:** [Formal Swedish maintenance notice — use standard orthography.]
...
- **Bad:** Random dialect mix or English filler in every Swedish sentence.

## What casual is not

- Not English sentence with one Swedish word
